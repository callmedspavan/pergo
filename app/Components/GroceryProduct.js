      ...
      <View style={styles.productcontainer}>
        ...
        <View style={styles.details}>
          <View style={styles.prices}>
            ...
            {mrp == 0 || sp == mrp ? null : (
              <View style={{ marginLeft: wp(5), alignSelf: "center" }}>
                <Text
                  style={{
                    fontFamily: "Alata_400Regular",
                    color: "grey",
            ...
            {offer == 0 ? null : <View style={styles.discount}>
          ...
          {sp == pp || prime == true ? null : <View style={styles.Prime}>
