...
function FruitsAndVegitablesLanding({ navigation }) {
  const entity = "Fruits %26 Vegitables";
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.searchbar}>
            <TouchableOpacity
              onPress={() => navigation.navigate("Fruits & Vegitables Search")}
...
export default FruitsAndVegitablesLanding;
