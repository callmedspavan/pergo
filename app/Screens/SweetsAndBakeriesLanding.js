...
function SweetsAndBakeriesLanding({ navigation }) {
  const entity = "Sweets %26 bakeries";
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.searchbar}>
            <TouchableOpacity
              onPress={() => navigation.navigate("Sweets & Bakery Search")}
...
export default SweetsAndBakeriesLanding;
